"""
Purpose: Handles orchestration of the system under experiment (SUE).
Functionality: Manages Docker Compose orchestration to set up and tear down services.
Connection: Called by the Engine to manage the lifecycle of the SUE.
